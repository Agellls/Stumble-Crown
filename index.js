...
╚══════╝   ╚═╝    ╚═════╝ ╚═╝     ╚═╝╚═════╝ ╚══════╝╚══════╝
    ...
    ██║  ██║╚██████╔╝███████║██║  ██║██║  ██╗                
    ╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝                               
By : ${chalk.red('@astargans')} - ${chalk.blue('galaucrew.my.id')} - ${chalk.yellow('@Adi_Nugroho')}
Features :
...
${chalk.red('Warning!')}
${chalk.green('ID: Jangan Gunakan Delay 1000-4000 Karna Akun Kalian Akan Terkena Ban')}
